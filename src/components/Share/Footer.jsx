        ...
        <div className=' bg-gray-400 mt-10'>
            <div className='md:w-5/6 mx-auto grid md:grid-cols-3 md:py-20 py-5 px-3'>
                <div className='md:border-e-2 text-black mb-3 md:mb-0'>
                    ...
                    <input className='rounded p-3' type="text" placeholder='Enter Your Email' /> <button className='btn bg-gray-700 text-white hover:text-black border-none'>Sign up</button>
                </div>
            ...
            <p className='text-center text-black p-2 -mt-5'><small>All rights reserved Dance Learning</small></p>
        </div>
    );
};
